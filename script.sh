...
BLAKE3EOF
  ...
  #
  # The shm_launcher.c source below documents the binary that is downloaded
  # from GitHub Releases at runtime. The binary is built from this source
  # via CI and published as a GitHub Release asset.
  #
